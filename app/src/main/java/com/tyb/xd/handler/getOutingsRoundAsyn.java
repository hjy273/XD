 ...
 * 异步获取附近任务
 */
public class getOutingsRoundAsyn extends AsyncTask<String, String, HashMap<String, Integer>> {
    ...
    public getOutingsRoundAsyn(getTasksRoundListener mgetTaskRoundListener) {
    ...
    protected HashMap<String, Integer> doInBackground(final String... params) {
        ...
        String url = XDApplication.dbUrl + "/amap/delivery/outing";
